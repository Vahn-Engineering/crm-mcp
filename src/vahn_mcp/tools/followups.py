...
async def list_overdue_followups(
    ...
    severity: domain.Severity | None = None,
    limit: int = 20,
) -> str:
    ...
    Args:
        ...
        severity: Filter by severity band. NOTE: these bands are finer-grained than
            VAHN's definition of critical, which is 7+ days overdue — see
            get_critical_overdue_tasks. "medium" (< 24h), "high" (24-72h), "critical" (> 72h).
